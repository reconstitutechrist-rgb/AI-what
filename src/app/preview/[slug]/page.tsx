  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-950">
      <div className="text-center">
        <div className="animate-spin rounded-full h-12 w-12 border-t-2 border-b-2 border-garden-500 mx-auto mb-4" />
    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-gray-950">
        <div className="text-center">
          ...
          <Link
            href="/"
            className="mt-4 inline-block px-4 py-2 bg-garden-600 text-white rounded-lg hover:bg-garden-700"
          >
