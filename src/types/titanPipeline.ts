...
/**
 * Tech Architecture Document — comprehensive system architecture analysis
 * produced by TechArchitectureService from TechDossier + VisionDocument.
 *
 * Separate from TechDossier: the dossier has research data,
 * this document has architecture analysis and feature mapping.
 */
export interface TechArchitectureDocument {
  /** High-level system architecture with layers */
  systemArchitecture?: SystemArchitecture;
  /** Mapping of each vision feature to technologies */
...
export interface SystemArchitecture {
  /** Prose overview of the architecture approach */
  overview: string;
  /** Architecture layers (Frontend, API, State, Data, etc.) */
  layers: ArchitectureLayer[];
}

export interface ArchitectureLayer {
  /** Layer name: "Frontend", "API Layer", "State Management", etc. */
  name: string;
  /** Technologies used in this layer */
  technologies: string[];
  /** What this layer is responsible for */
  responsibilities: string[];
  /** Which other layers this connects to */
  connectsTo: string[];
}

export interface FeatureTechMapping {
  /** The feature title from the Vision Document */
  featureTitle: string;
  /** Technologies that implement this feature */
  technologies: string[];
...
export interface DataFlowDescription {
  /** Flow name: "User Authentication", "Content Creation", etc. */
  flowName: string;
  /** Step-by-step flow with technology labels */
  steps: DataFlowStep[];
  /** All technologies involved in this flow */
...
export interface DataFlowStep {
  ...
  description: string;
  /** Which technology handles this step */
  technology: string;
}

export interface IntegrationPattern {
  /** Pattern name: "State-UI Integration", "API Communication", etc. */
  pattern: string;
  /** Technologies involved in this pattern */
  technologies: string[];
