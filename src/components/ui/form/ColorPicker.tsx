    ...
    <div className="py-3">
      ...
      <div className="flex items-center gap-3">
        ...
        <input
          ...
          value={value}
          onChange={(e) => onChange(e.target.value)}
          className="flex-1 px-3 py-2 rounded-lg bg-slate-800 border border-white/10 text-white font-mono text-sm focus:outline-none focus:ring-2 focus:ring-garden-500"
        />
      </div>
