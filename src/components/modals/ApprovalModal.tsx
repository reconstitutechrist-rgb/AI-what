    ...
    >
      ...
      >
        ...
        <div className="px-6 py-4 border-b border-zinc-800">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-zinc-400">Review the proposed modifications to your app</p>
            </div>
          </div>
        </div>
        ...
        <div className="px-6 py-5">
          ...
          <div className="mb-6">
            <label className="text-sm font-medium text-zinc-300 mb-2 block">Files affected:</label>
