      ...
      <div className="px-4 py-3 border-b border-slate-700">
        <div className="flex items-center justify-between mb-3">
          ...
          {onSave && (
            <button
              ...
              className="px-3 py-1.5 text-xs bg-garden-600 hover:bg-garden-500 text-white rounded-md transition-colors flex items-center gap-1.5"
            >
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-9 pr-3 py-2 text-sm bg-slate-800 border border-slate-700 rounded-lg text-white placeholder-slate-500 focus:outline-none focus:border-garden-500"
          />
        </div>
      </div>
          ...
          <div className="flex flex-col items-center justify-center h-full">
            ...
            {searchQuery && (
              <button
                ...
                className="mt-2 text-xs text-garden-400 hover:text-garden-300"
              >
                Clear search
              </button>
            )}
            ...
            <div className="flex items-center justify-between px-4 py-3 border-t border-slate-700">
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className="px-4 py-2 text-sm bg-garden-600 hover:bg-garden-500 text-white rounded-lg transition-colors"
                >
                  Apply Template
                </button>
              </div>
          ...
          <div className="w-full max-w-md mx-4 bg-slate-900 rounded-xl border border-slate-700 overflow-hidden">
            ...
            <div className="p-4 space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 text-sm bg-slate-800 border border-slate-700 rounded-lg text-white placeholder-slate-500 focus:outline-none focus:border-garden-500"
                  autoFocus
                />
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-3 py-2 text-sm bg-slate-800 border border-slate-700 rounded-lg text-white focus:outline-none focus:border-garden-500"
                >
            ...
            <div className="flex items-center justify-end gap-2 px-4 py-3 border-t border-slate-700">
              ...
              <button
                ...
                className="px-4 py-2 text-sm bg-garden-600 hover:bg-garden-500 disabled:bg-slate-700 disabled:text-slate-400 text-white rounded-lg transition-colors"
              >
                Save Template
              </button>
            </div>
