...
export const saasTemplate: FullTemplate = {
  ...
  description: 'Subscription-based applications with authentication, onboarding wizard, dashboard, and team management.',
  icon: '🚀',
  category: 'saas',
  features: [
    'Authentication',
...
- Navigation between main sections`,
  ...
  components: [
    ...
    { name: 'OnboardingStep', description: 'Individual onboarding step component', priority: 'core' },
