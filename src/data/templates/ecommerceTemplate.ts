...
export const ecommerceTemplate: FullTemplate = {
  id: 'ecommerce',
  name: 'E-commerce',
  description: 'Product catalogs and shopping experiences with cart, checkout, and category navigation.',
  icon: '🛒',
  category: 'commerce',
  features: [
    'Product grid',
...
- Price display with sale/discount support`,
  ...
  components: [
    ...
    { name: 'ProductCard', description: 'Product thumbnail with price and quick add', priority: 'core' },
    { name: 'ProductDetail', description: 'Full product page with gallery', priority: 'core' },
    { name: 'ShoppingCart', description: 'Cart sidebar or page with item management', priority: 'core' },
    ...
    { name: 'SearchAutocomplete', description: 'Search with product suggestions', priority: 'optional' },
    { name: 'ProductFilters', description: 'Filter panel for price, category, etc.', priority: 'optional' },
